...
public class PartyIndicator {
    public static void main(String[] args) {
        ...
        System.out.println("Number 1- girls");
        int numberGirls = scanner.nextInt();
        System.out.println("Number 2 - boys");
        int numberBoys = scanner.nextInt();
        int onParty = numberGirls + numberBoys;
        //int genderRatio = numberGirls / numberBoys;

        if (numberGirls == 0) {
            System.out.println("Sausage party");
        } else if (onParty < 20) {
            System.out.println("Average party...");
        } else if (numberGirls == numberBoys) {
